...
/// based argument list.
///
/// The `max_level_*` features can be used to statically disable logging at various
/// levels.
#[macro_export]
macro_rules! log {
...
///
/// Logging at this level is disabled if any of the following features are present:
/// `max_level_off` or `max_level_error`.
///
/// When building in release mode (i.e., without the `debug_assertions` option), logging at this
/// level is also disabled if any of the following features are present:
/// `release_max_level_off` or `max_level_error`.
#[macro_export]
macro_rules! warn {
    (target: $target:expr, $($arg:tt)*) => (
...
///
/// Logging at this level is disabled if any of the following features are present:
/// `max_level_off`, `max_level_error`, or `max_level_warn`.
///
/// When building in release mode (i.e., without the `debug_assertions` option), logging at this
/// level is also disabled if any of the following features are present:
/// `release_max_level_off`, `release_max_level_error`, or `release_max_level_warn`.
#[macro_export]
macro_rules! info {
    (target: $target:expr, $($arg:tt)*) => (
...
///
/// Logging at this level is disabled if any of the following features are present:
/// `max_level_off`, `max_level_error`, `max_level_warn`, or `max_level_info`.
///
/// When building in release mode (i.e., without the `debug_assertions` option), logging at this
/// level is also disabled if any of the following features are present:
/// `release_max_level_off`, `release_max_level_error`, `release_max_level_warn`, or
...
///
/// Logging at this level is disabled if any of the following features are present:
/// `max_level_off`, `max_level_error`, `max_level_warn`, `max_level_info`, or `max_level_debug`.
///
/// When building in release mode (i.e., without the `debug_assertions` option), logging at this
/// level is also disabled if any of the following features are present:
